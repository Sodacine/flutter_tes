...
class _ProfilePageState extends State<ProfilePage> {
  // Data profil
  String name = 'Rangga Satria Kencana';
  String bio = 'Mahasiswa Sistem Informasi | Tea Barista Molly Tea.'
  ...
  String location = 'Tangerang Selatan, Indonesia';
                ...
                child: Stack(
                  ...
                  children: [
                    Opacity(
                      opacity: 0.9,
                      child: Image.network(
                        'https://plus.unsplash.com/premium_photo-1774416430860-4f0847799ee7?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Column(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        _buildStatCard('Posts', '69', Icons.photo_library),
                        _buildStatCard('Followers', '67.67K', Icons.people),
                        _buildStatCard('Following', '67', Icons.person_add),
                      ],
                    ),
  ...
  ImageProvider _getAvatarImage() {
    if (avatarFile != null) {
      ...
      return const NetworkImage('https://images.unsplash.com/photo-1774314706341-041341ae7af5?q=80&w=1325&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
    }
  }
