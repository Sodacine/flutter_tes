...
class DateTimePickerForm extends StatefulWidget {
  ...
  @override
  State<DateTimePickerForm> createState() => DateTimePickerFormState();
}

class DateTimePickerFormState extends State<DateTimePickerForm> {
  ...
  String _fmtDateShort(DateTime d) =>
      ...
      '${_namaBulan[d.month - 1].substring(0, 3)} ${d.year}';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Date & Time Picker',
            style: TextStyle(fontWeight: FontWeight.w600, letterSpacing: 0.5)), // Text
        centerTitle: true,
        elevation: 0,
      ), // AppBar
              ...
              FilledButton.icon(
                ...
                style: FilledButton.styleFrom(
                  ...
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(14)), // RoundedRectangleBorder
                  textStyle: const TextStyle(
                      fontSize: 16, fontWeight: FontWeight.w600), // TextStyle
                ),
    ...
    return TextFormField(
      ...
      decoration: _deco(
        ...
        suffix: const Icon(Icons.chevron_right_rounded,
            color: Color(0xFF6C63FF), size: 20), // Icon
      ),
    ); // TextFormField
  }
  ...
  InputDecoration _deco({
    ...
    return InputDecoration(
      ...
      border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none), // OutlineInputBorder
      enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(
              color: Colors.grey.withOpacity(0.2), width: 1)), // OutlineInputBorder
      focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(
              color: Color(0xFF6C63FF), width: 1.5)), // OutlineInputBorder
      errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(
              color: Colors.redAccent, width: 1)), // OutlineInputBorder
      focusedErrorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: const BorderSide(
              color: Colors.redAccent, width: 1.5)), // OutlineInputBorder
  ...
  Widget _buildPreviewCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: const Color(0xFF6C63FF).withOpacity(0.2), width: 1), // Border.all
      ), // BoxDecoration
      child: Column(
          ...
          const Row(children: [
            ...
            Text('Preview Data',
                style: TextStyle(
                    ...
                    fontSize: 14)), // TextStyle // Text
          ]), // Row
          const Divider(height: 16),
          if (_titleController.text.isNotEmpty)
            _previewRow(Icons.title_rounded, 'Judul', _titleController.text),
          if (_dateController.text.isNotEmpty)
            _previewRow(Icons.calendar_today_rounded, 'Tanggal', _dateController.text),
          if (_timeController.text.isNotEmpty)
            _previewRow(Icons.access_time_rounded, 'Waktu', _timeController.text),
          if (_startDateController.text.isNotEmpty)
            _previewRow(Icons.date_range_rounded, 'Rentang',
                '${_startDateController.text} - ${_endDateController.text}'),
          if (_dateTimeController.text.isNotEmpty)
            _previewRow(Icons.schedule_rounded, 'Tgl & Waktu', _dateTimeController.text),
        ],
      ), // Column
    ); // Container
  }
      ...
      child: Row(children: [
        ...
        Text('$label: ',
            style: const TextStyle(
                ...
                fontSize: 13,
                color: Color(0xFF4B5563))), // TextStyle // Text
        Expanded(
          child: Text(value,
              style: const TextStyle(
                  fontSize: 13,
                  color: Color(0xFF1A1A2E),
                  overflow: TextOverflow.ellipsis)), // TextStyle // Text // Expanded
        ),
      ]), // Row
    ); // Padding
  }
          ...
          Row(children: [
            ...
            Text(title,
                style: const TextStyle(
                    fontWeight: FontWeight.w600,
                    fontSize: 14,
                    color: Color(0xFF1A1A2E))), // TextStyle // Text
          ]), // Row
