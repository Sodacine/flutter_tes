...
class _CompleteFormPageState extends State<AutocompletespinPage> {
  ...
  // Controllers untuk Autocomplete [cite: 78]
  final TextEditingController _universityController = TextEditingController();
  final TextEditingController _majorController = TextEditingController();

  // Selected values untuk dropdown [cite: 78]
  String? _selectedEducationLevel;
  String? _selectedYear;

  // Data options [cite: 78, 79]
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Autocomplete Universitas [cite: 80]
                      ...
                      // Dropdown Jenjang Pendidikan [cite: 81]
                      _buildDropdownField(
  ...
  // Widget Builder untuk Autocomplete [cite: 81, 82]
  ...
  // Widget Builder untuk Dropdown [cite: 83]
  ...
  // Widget Builder untuk Tombol Submit [cite: 84]
  ...
  // Helper untuk baris detail di dialog [cite: 85]
